        ...
        <div className="document_posts">
          <div className="document_background">
              ...
              {isOpend&&
                ...
                <a href="https://kauth.kakao.com/oauth/authorize?client_id=e94722859a13a96095d4b975965b3a3f&redirect_uri=http://growactions.co.kr/kakaoLogin&response_type=code"><div className="document_menu_text">Kakao Login</div></a>
